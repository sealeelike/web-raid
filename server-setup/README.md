...
单机加密备份系统的 VPS 端一键部署脚本。配套的笔记本端项目见仓库根目录下的 [`client/`](../client/)。
...
重新运行本脚本可以调整保留份数等参数，不会丢已有归档。详细设计和真实测试记录见 [`client/doc/09-archive-and-prune.md`](../client/doc/09-archive-and-prune.md)。
